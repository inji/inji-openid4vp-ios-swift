...
class ClientIdSchemeBasedAuthorizationRequestTests : XCTestCase {
    ...
    func testFetchAuthorizationRequestByReference() async{
        ...
        do{
            try await mockAuthHandler.fetchAuthorizationRequest(walletNonce: "wallet-nonce")
    ...
    func testFetchAuthRequestShouldThrowErrorWhenRequestUriIsNotHttpsScheme() async{
        ...
        await assertAsyncThrowsError(try await mockAuthHandler.fetchAuthorizationRequest(walletNonce: "wallet-nonce")) { error in
