...
let ldpVPTokenSigningResult = VPTokenSigningResult(id: "uuid1", signedData: Data("validJWS".utf8))

let mdocSigningResult = VPTokenSigningResult(id: "uuid1", signedData: Data("signature".utf8))
