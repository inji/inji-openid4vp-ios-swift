...
public class OpenID4VP {
    ...
    public func authenticateVerifier(encodedAuthorizationRequest: String, trustedVerifierJSON: [Verifier], shouldValidateClient: Bool = false, walletMetadata: String?) async throws -> AuthorizationRequest {
